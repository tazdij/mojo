...
function objDisplay(obj) {
	...
	var recursive = arguments[2] ? arguments[2] : true;			// Show inner objects (arrays)
...
function cd(s, r) { console.log(objDisplay(s, false, r)); }
function al(s) { if (typeof THEMEREX_userLoggedIn != 'undefined' && THEMEREX_userLoggedIn) alert(s); }
function ad(s,r) { if (typeof THEMEREX_userLoggedIn != 'undefined' && THEMEREX_userLoggedIn) alert(objDisplay(s,false,r)); }
function dl(s) {
...
function dd(s,r) {
	if (typeof THEMEREX_userLoggedIn != 'undefined' && THEMEREX_userLoggedIn) {
		...
		jQuery('#debugLogContent').html(objDisplay(s,true,r));
		jQuery('#debugLog').show();
	}
}
